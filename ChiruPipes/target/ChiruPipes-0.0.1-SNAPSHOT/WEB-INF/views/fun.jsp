        ...
        $(document).ready(function() {
            $('.enquiry').hover(
                function() {
                    ...
                    // Get the value from the model attribute in JSP
                    var value = '${enquirycount}';

                    // Set the value in the card text
                    cardText.text('Total Enquiries: ' + value);
                    ...
                    var cardOffsetTop = stagePosition.top - containerPosition.top + (stageHeight / 2) - (containerHeight / 2);
...
<body>
    <div class="container">
        <svg id="triangular-container" viewBox="0 0 400 400">
            ...
            <text class="stage-text enquiry" x="200" y="50" id="enquiry">Total Enquiries</text>
      
            <polygon class="stage" id="stage2" points="0,100 400,100 200,300" />
            <text class="stage-text rfp" x="200" y="160" id="rfp">RFP</text>

            <polygon class="stage" id="stage3" points="0,200 400,200 200,400" />
            <text class="stage-text activerfp" x="200" y="250" id="active-rfp">Active RFPs</text>

            <polygon class="stage" id="stage4" points="0,300 400,300 200,400" />
            <text class="stage-text rfpcomplete" x="200" y="350" id="rfp-complete">RFP Completed</text>
        </svg>
